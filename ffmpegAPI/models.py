...
class Generatevideo(models.Model):
    id = models.BigIntegerField(primary_key=True)
    userid = models.BigIntegerField(db_column='userId', blank=True, null=True)  # Field name made lowercase.
    operadate = models.DateTimeField(blank=True, null=True)
    finished = models.IntegerField(blank=True, null=True)
    pushback = models.IntegerField(blank=True, null=True)
    url = models.CharField(max_length=2000, blank=True, null=True)
    iurl = models.CharField(db_column='Iurl', max_length=2000, blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = True
        db_table = 'generatevideo'
